...
export default function AnalyticsError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 p-6">
      ...
      <h1 className="text-xl font-semibold text-fg">Analytics Failed to Load</h1>
      <p className="text-sm text-fg-muted text-center max-w-md">
        {error.message || "An unexpected error occurred while loading analytics. Please try again."}
      </p>
      <button
        onClick={reset}
