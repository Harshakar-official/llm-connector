...
export default function FindingDetailError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 p-6">
      ...
      <h1 className="text-xl font-semibold text-fg">Finding Failed to Load</h1>
      <p className="text-sm text-fg-muted text-center max-w-md">
        {error.message || "An unexpected error occurred while loading this finding. It may have been deleted or you may not have access."}
      </p>
      <button
        onClick={reset}
