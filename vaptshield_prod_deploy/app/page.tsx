      ...
      <section className="relative overflow-hidden pb-20 pt-32 md:pt-48 lg:pb-32 lg:pt-56">
        <div className="container relative z-10 mx-auto px-6 text-center text-fg">
          ...
          <h1 className="mx-auto max-w-5xl text-5xl font-extrabold tracking-tight sm:text-6xl lg:text-7xl">
            ...
            <span className="bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent underline decoration-primary/20 decoration-4 underline-offset-8 italic">Enterprise VAPT & Pentesting</span>
          </h1>
          ...
          {/* Real Dashboard Preview with Theme-Aware Switching */}
          <div className="mt-20 relative mx-auto max-w-6xl group">
            <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-primary/30 to-blue-500/30 blur-2xl opacity-50 group-hover:opacity-75 transition-opacity" />
            <div className="relative rounded-2xl border border-border bg-panel shadow-2xl overflow-hidden aspect-[16/9]">
              {/* Window Header */}
              <div className="flex h-10 items-center justify-between border-b border-border bg-bg-subtle px-4 z-20 relative">
              ...
              <div className="relative w-full h-full">
                <Image 
                  ...
                  fill
                  className="object-cover object-top dark:opacity-0 transition-opacity duration-500"
                  priority
                />
                <Image 
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-16 md:gap-32">
             ...
             <div className="flex items-center gap-4 group cursor-default">
               <div className="relative h-12 w-32 md:h-14 md:w-40 grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all duration-500 transition-transform group-hover:scale-105">
                 <Image 
